                    ...
                    <tr class="border-base-300">
                        {#each visibleColumns as column}
                            <th class="bg-base-200/50">
                                <div
                                    class="skeleton-loader h-4 w-24 rounded"
                                ></div>
                            </th>
                        {/each}
                    </tr>
                    ...
                    {#each Array(rowsPerPage) as _, i}
                        <tr>
                            {#each visibleColumns as column}
                                <td>
                                    <div
                                        class="skeleton-loader h-4 w-32 rounded"
                                    ></div>
                                </td>
                            {/each}
                        </tr>
                ...
                <thead>
                    <tr class="border-base-300">
                        {#each visibleColumns as column}
                            ...
                            >
                                <div
                                    class="flex items-center gap-2 {column.align ===
                                    'center'
                                        ? 'justify-center'
                                        : column.align === 'right'
                                          ? 'justify-end'
                        ...
                        {/each}
                        {#if rowActions}
                            <th class="bg-base-200/50 text-right w-[100px]"
                                >Aksi</th
                            >
                        {/if}
                    </tr>
                        ...
                        <tr>
                            ...
                            >
                                <div class="flex flex-col items-center gap-3">
                                    ...
                                    {:else}
                                        <div
                                            class="p-4 bg-base-200 rounded-full"
                                        >
                                            <Inbox
                                    ...
                                    <div>
                                        ...
                                        {#if searchTerm}
                                            ...
                                            >
                                                Coba kata kunci pencarian yang
                                                berbeda
                                            </p>
                                        {/if}
                                    </div>
