<script lang="ts">
	...
	import type { Pekerjaan } from '$lib/utils/db';
	...
	export let filterPekerjaan: string = '';
	let kerjaan: any[] = [];
...
<Button
	size="sm"
	class={`fixed ${expanded ? 'left-64' : 'left-16'} top-[22rem] z-10 my-auto rounded-xl opacity-30 transition-all duration-300 hover:opacity-90`}
