...
<section id="features" class="bg-white dark:bg-gray-900">
    ...
    >
        ...
        <div class="mt-8 grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3">
            <div
                class="block rounded-xl border border-gray-200 p-8 shadow-xl transition hover:border-pink-500/10 hover:shadow-pink-500/10 dark:border-gray-800 dark:shadow-gray-800/25"
            >
                <svg
...
<footer class="bg-gray-100 dark:bg-gray-800">
    ...
    >
        ...
        <p
            class="mt-12 text-center text-sm text-gray-500 lg:text-right dark:text-gray-400"
        >
